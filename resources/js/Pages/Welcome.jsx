    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-white text-slate-800">
                    ...
                    <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {canLogin && (
                                <Link
                                    href={route('login')}
                                    className="hidden rounded-lg border border-blue-600 px-5 py-2.5 text-sm font-semibold text-blue-600 transition hover:bg-blue-50 sm:inline-flex"
                                >
                                    Log in
                                </Link>
                            )}
                ...
                <section
                    id="home"
                    className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-sky-50"
                >
                    ...
                    <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2 lg:px-8 lg:py-24">
                        ...
                        <div>
                            ...
                            <h1 className="max-w-2xl text-5xl font-extrabold leading-tight tracking-tight text-[#102a56] sm:text-6xl">
                                Bizz
                            ...
                            <h2 className="mt-2 text-2xl font-bold text-[#193d70] sm:text-3xl">
                                Inventory Management System
                            </h2>
                            ...
                            <div className="mt-8 flex flex-wrap gap-4">
                                ...
                                <a
                                    href="#features"
                                    className="inline-flex items-center gap-2 rounded-xl border-2 border-blue-600 bg-white px-7 py-3.5 font-semibold text-blue-600 transition hover:bg-blue-50"
                                >
                                    <span>ⓘ</span>
                                    Learn More
                                </a>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative rounded-3xl border border-white bg-white p-3 shadow-2xl shadow-blue-900/10">
                ...
                >
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <h2 className="text-3xl font-extrabold text-[#102a56] sm:text-4xl">
                ...
                >
                    ...
                    <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
                        ...
                        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-600">
                            BizzSoft is an Inventory Management System designed
                            around a modern Laravel backend and a React-based
                            user interface powered by Inertia.js. The system
                            combines inventory management, transaction
                            processing, reporting, authentication, database-
                            driven RBAC and activity logging into one
...
function FeatureCard({
    ...
    return (
        <div className="group flex gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl hover:shadow-blue-900/5">
            ...
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-100 text-blue-600 transition group-hover:bg-blue-600 group-hover:text-white">
                →
            </div>
...
function TechCard({
    ...
    return (
        <div className="flex min-h-28 flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-5 text-center shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
